...
from app.schemas.listing import ListingDetailsResponse, ListingImageResponse
from app.schemas.review import ReviewListResponse


async def fetch_full_listing_info(listing_id: str, user_id: str, db: Session) -> ListingDetailsResponse:
    try:
        ...
        if not listing.owner_id == user_id and db.get(User, user_id):
