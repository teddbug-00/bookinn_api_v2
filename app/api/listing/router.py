...
from app.api.listing.handlers.create import create_listing
from app.api.listing.handlers.delete import remove_listing
from app.api.listing.handlers.detail import fetch_full_listing_info
from app.api.listing.handlers.list import fetch_listings
from app.api.listing.handlers.reviews import fetch_reviews
from app.api.listing.handlers.update import update_listing
from app.api.listing.handlers.add_bookmark import add_bookmark
from app.core.db import get_db
from app.core.security.tokens import get_current_user_id
from app.schemas.listing import ListingCreateRequest, ListingCreateResponse, ListingDetailsResponse, ListingUpdateRequest, \
...
async def get_listing_details(
    ...
    return await fetch_full_listing_info(listing_id, user_id, db)
